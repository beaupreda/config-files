...
return {
  ...
  on_attach = function(client, bufnr)
	...
	-- Add keymap to export to PDF.
    local cmd_func, _, cmd_desc = create_tinymist_command('tinymist.exportPdf', client, bufnr)
    vim.keymap.set('n', '<leader>tp', cmd_func, { desc = cmd_desc })
  end,
}
